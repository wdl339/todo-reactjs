            ...
            <div className='col-9'>
                ...
                <div class="modal fade" id="detailModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-body">
                            <p>1. 同步canvas任务和同步教务处通知，点击按钮后，请等待至少7秒，然后手动刷新页面。</p>
                            <p>2. 请不要频繁地使用同步教务处通知的功能，万一把教务处网站搞崩溃就麻烦了。</p>
                            <p>3. 任务展示是按照deadLine时间排序的，记录展示是按添加/发布时间排序的。</p>
                            <p>4. 同步教务处通知时，会添加教务处最新的10条通知。不会重复添加，但如果你删掉过这10条之一的通知，它也会再被添加上。
                                因此，我建议你在“非精选”一栏里保留10条来自教务处的通知，然后超过这10条的不重要的通知都可以删掉了。
                            </p>
                            <p>5. 不要存太多不重要的记录，不然我数据库内存不够。</p>
                            <p>6. 点击任务/记录标题可以进入详情页面。刚同步的教务处通知的细节部分是有所省略的，可以点击“更新”按钮来获取完整内容。也请不要频繁地使用更新功能。</p>
                            <p>7. 一切解释权归wdl同学所有，不懂就问。</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">我知道了</button>
                        </div>
